...
declare module kendo.data {
    ...
    class ObservableArray<T> extends Observable {
        ...
        filter(callback: (item: T, index: number, source: ObservableArray<T>) => bool): any[];
        find(callback: (item: T, index: number, source: ObservableArray<T>) => bool): any;
        every(callback: (item: T, index: number, source: ObservableArray<T>) => bool): bool;
        some(callback: (item: T, index: number, source: ObservableArray<T>) => bool): bool;
        remove(item: T): void;
    }

    class DataSource<T extends kendo.data.Model> extends Observable {
        constructor(options?: DataSourceOptions<T>);
        static create<T extends kendo.data.Model>(options?: DataSourceOptions<T>): DataSource;
...
declare module kendo.ui {
    ...
    class Validator extends kendo.ui.Widget {
        ...
        validateInput(input: JQuery): bool;
    }
